...
def main():
    ...
    markers = sorted(markers, key = lambda m: (m[c4d.TLMARKER_TIME] + m[c4d.TLMARKER_LENGTH]))
    ...
    loop_max = next_ranged_marker[c4d.TLMARKER_TIME] + next_ranged_marker[c4d.TLMARKER_LENGTH] - one_frame
